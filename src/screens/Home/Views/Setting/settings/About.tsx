...
export default memo(() => {
  ...
  const openIssuePage = () => {
    void openUrl(`https://github.com/${RELEASE_REPOSITORY}/issues?q=is%3Aissue+`)
  }
  ...
  const openPartPage = () => {
    void openUrl(`https://github.com/${RELEASE_REPOSITORY}#%E9%A1%B9%E7%9B%AE%E5%8D%8F%E8%AE%AE`)
  }
    ...
    <Section title={t('setting_about')}>
      <View style={styles.part}>
        ...
        <TouchableOpacity onPress={openHomePage}>
          <Text style={textLinkStyle}>https://github.com/{RELEASE_REPOSITORY}</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.part}>
